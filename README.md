...
**~8 800 строк** · **60 модулей** · **26 хендлеров** · **28 таблиц БД**
...
(CSV/JSON/ZIP) · **бэкап и восстановление БД** · возврат донатов Telegram Stars ·
maintenance-режим · reload `.env` без рестарта.
...
- **Сохранность данных** — ежедневный авто-бэкап БД (атомарный снимок через SQLite backup API) с доставкой админу в Telegram и восстановлением из файла в один шаг.
...
| `/backup` · `/restore` | Бэкап БД и восстановление из файла |
| `/refund <charge_id>` | Возврат доната Telegram Stars |
